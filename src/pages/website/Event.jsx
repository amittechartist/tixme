            ...
            <div className="event-page-header mt-5 mb-5">
                <Container>
                    <div className="mt-5">
                        ...
                        <p className="event-title mt-5">Grand Night Party</p>
                    </div>
                    <div>
                        <div className="organizer-name-sec px-2 py-2">
                            ...
                            <div className="d-inline-flex align-items-center">
                                ...
                                <div className="d-inline-block">
                                    <span className="event-duration d-block">Wilton , United States</span>
                    ...
                    <Row className="mt-5">
                        <Col md={12}>
                            <span className="float-right"><img className="mx-1" src={HeartIcon} alt="" /><img className="mx-1" src={ShareIcon} alt="" /></span>
                        </Col>
                        <Col md={12}>
                    ...
                    <Row>
                        <Col md={8}>
                            <div className="desc-sec">
                                <span className="sec-title">Description</span>
                                <p>
                                    ...
                                    Lorem ipsum is mostly a part of a Latin text by the classical author and philosopher Cicero. Its words and letters have been changed by addition or removal,

                                    so to deliberately render its content nonsensical; it's not genuine, correct, or comprehensible Latin anymore.
                            ...
                            <div className="desc-sec">
                                <span className="sec-title">Return Policy <span><img src={ShareIcon} alt="" /></span></span>
                                <p className="report"><img src={FlagIcon} alt="" /> Report this event</p>
                            </div>
                            <Row>
                                <Col md={12}>
                        ...
                        <Col md={4}>
                            <div className="start-in-box eventpage-box-style mb-5">
                                ...
                                <div className="right-box-con mt-4">
                                    <div className="time-box d-inline-block text-center">
                                        <p className="time-box-date">15</p>
                            ...
                            <div className="organised-by-box eventpage-box-style">
                                ...
                                <div className="right-box-con mt-4">
                                    ...
                                    <div className="d-inline-flex align-items-center py-2">
                                        ...
                                        <div className="d-inline-block">
                                            <span className="event-page-organizer-deta d-block">454 Isaac Frye Hwy, Wilton, United States</span>
                                        </div>
                                    </div>
                                    <div className="d-inline-flex align-items-center py-2">
                                        <div className="d-inline-block mr-1">
                                        ...
                                        <div className="d-inline-block">
                                            <span className="event-page-organizer-deta d-block">kin@gmail.com</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="start-in-box eventpage-box-style mb-5 my-5">
                                ...
                                <div className="right-box-con mt-4">
                                    ...
                                    <div className="organizer-name-sec px-2 py-2 margin-css">
                                        ...
                                        <div className="d-inline-flex align-items-center border-right event-time-area">
                                            ...
                                            <div className="d-inline-block">
                                                <span className="event-duration d-block font-13">Event Time</span>
                                                <span className="event-time d-block">07 : 00 PM</span>
                                            </div>
                                        </div>
                                        <div className="d-inline-flex align-items-center">
                                            <div className="d-inline-block mr-1">
                                                <img height={20} width={20} src={Hourglasslogo} alt="" />
                                            </div>
                                            <div className="d-inline-block">
                                                <span className="event-duration d-block font-13">Event Duration</span>
                                                <span className="event-time d-block">2Hr 11Min</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="dashed-border-devider my-2"></div>
                                <div>
                                    <span className="main-title">Total Price :</span> <span className="float-right main-title">$ 95.00</span>
                                </div>
                                <div className="mt-5">
